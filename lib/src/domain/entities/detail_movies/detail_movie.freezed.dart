...
// ignore: unused_element
  _DetailMovie call(
      ...
      @required @nullable SimilarMovie similar,
...
class _$DetailMovieCopyWithImpl<$Res> implements $DetailMovieCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      similar: similar == freezed ? _value.similar : similar as SimilarMovie,
  ...
  $SimilarMovieCopyWith<$Res> get similar {
    ...
    return $SimilarMovieCopyWith<$Res>(_value.similar, (value) {
...
abstract class _DetailMovie implements DetailMovie {
  const factory _DetailMovie(
      ...
      @required @nullable Credit credits,
      @required @nullable Image images,
      @required @nullable Review reviews}) = _$_DetailMovie;
