...
import 'package:the_movie_wiki/src/ui/discover_movies/bloc/discover_movie_bloc.dart';

import '../../../../fixtures/fixture_reader.dart';

class MockGetDiscoverMovieData extends Mock implements GetDiscoverMovie {}
      ...
      blocTest(
        ...
        act: (DiscoverMovieBloc bloc) async {
          final act = bloc
            ...
            ..add(DiscoverMovieEvent.getMovieData(
              type: 'now_playing',
              page: 1,
            ));
          return act;
